...
export const mediaWorkloadData: WorkloadDataItem[] = [
  { id: "u1", name: "张三", 待审批流量主申请: 9, 待邀约: 6, 已邀约待回应: 7, "可合作待提报/自申请": 4, 待报价: 5, 待流量主确认合作: 3, 待确认合作: 4, "待执行(待提稿)": 6, "待执行(待重新提稿)": 3, 待审稿: 8, "待执行(已定稿)": 5, 待我审核支出: 2, 待申请支付: 8 },
  { id: "u2", name: "李四", 待审批流量主申请: 12, 待邀约: 8, 已邀约待回应: 9, "可合作待提报/自申请": 5, 待报价: 8, 待流量主确认合作: 4, 待确认合作: 4, "待执行(待提稿)": 15, "待执行(待重新提稿)": 4, 待审稿: 5, "待执行(已定稿)": 8, 待我审核支出: 3, 待申请支付: 10 },
  { id: "u3", name: "王五", 待审批流量主申请: 8, 待邀约: 5, 已邀约待回应: 6, "可合作待提报/自申请": 3, 待报价: 6, 待流量主确认合作: 2, 待确认合作: 3, "待执行(待提稿)": 12, "待执行(待重新提稿)": 2, 待审稿: 14, "待执行(已定稿)": 6, 待我审核支出: 7, 待申请支付: 8 },
  { id: "u4", name: "赵六", 待审批流量主申请: 6, 待邀约: 4, 已邀约待回应: 5, "可合作待提报/自申请": 3, 待报价: 4, 待流量主确认合作: 2, 待确认合作: 2, "待执行(待提稿)": 9, "待执行(待重新提稿)": 2, 待审稿: 6, "待执行(已定稿)": 4, 待我审核支出: 1, 待申请支付: 6 },
  { id: "u5", name: "孙七", 待审批流量主申请: 10, 待邀约: 7, 已邀约待回应: 8, "可合作待提报/自申请": 4, 待报价: 7, 待流量主确认合作: 3, 待确认合作: 5, "待执行(待提稿)": 18, "待执行(待重新提稿)": 5, 待审稿: 11, "待执行(已定稿)": 9, 待我审核支出: 4, 待申请支付: 12 },
  { id: "u6", name: "周八", 待审批流量主申请: 4, 待邀约: 3, 已邀约待回应: 4, "可合作待提报/自申请": 2, 待报价: 3, 待流量主确认合作: 1, 待确认合作: 2, "待执行(待提稿)": 5, "待执行(待重新提稿)": 1, 待审稿: 4, "待执行(已定稿)": 3, 待我审核支出: 2, 待申请支付: 4 },
  { id: "u7", name: "吴九", 待审批流量主申请: 11, 待邀约: 6, 已邀约待回应: 7, "可合作待提报/自申请": 4, 待报价: 9, 待流量主确认合作: 3, 待确认合作: 4, "待执行(待提稿)": 14, "待执行(待重新提稿)": 3, 待审稿: 9, "待执行(已定稿)": 7, 待我审核支出: 5, 待申请支付: 9 },
  { id: "u8", name: "郑十", 待审批流量主申请: 7, 待邀约: 5, 已邀约待回应: 5, "可合作待提报/自申请": 3, 待报价: 5, 待流量主确认合作: 2, 待确认合作: 3, "待执行(待提稿)": 7, "待执行(待重新提稿)": 2, 待审稿: 3, "待执行(已定稿)": 5, 待我审核支出: 1, 待申请支付: 5 },
  { id: "u9", name: "钱一", 待审批流量主申请: 13, 待邀约: 9, 已邀约待回应: 10, "可合作待提报/自申请": 6, 待报价: 10, 待流量主确认合作: 4, 待确认合作: 6, "待执行(待提稿)": 20, "待执行(待重新提稿)": 6, 待审稿: 12, "待执行(已定稿)": 10, 待我审核支出: 6, 待申请支付: 15 },
  { id: "u10", name: "陈二", 待审批流量主申请: 5, 待邀约: 3, 已邀约待回应: 4, "可合作待提报/自申请": 2, 待报价: 2, 待流量主确认合作: 1, 待确认合作: 1, "待执行(待提稿)": 4, "待执行(待重新提稿)": 1, 待审稿: 2, "待执行(已定稿)": 2, 待我审核支出: 2, 待申请支付: 3 },
];
...
export const mediaBars: WorkloadBarConfig[] = [
  ...
  { key: "待邀约", color: "#bfdbfe" },
  { key: "已邀约待回应", color: "#c7d2fe" },
